...
export function SiteNavigation() {
 ...
 return <header className={`site-header minimal`}>
  <nav className="minimal-nav" aria-label="Main navigation">
   <Link href="/about" className="nav-item about">A B O U T</Link>
   <Link href="/store" className="nav-item store">S T O R E</Link>
   <Link href="/cart" className="nav-item cart">C A R T ({count})</Link>
  </nav>
 </header>;
}
